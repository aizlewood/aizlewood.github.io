...
<div class="Block Block--curriculum-standard">
    <div class="Block-container">
        <div class="Block-content">
            <span class="Block-metaAttr"><?php echo $block['set-name'] ?> | <?php echo $block['country-name'] ?></span>
            <a class="Block-title" href="browse-structure-nodes?business=<?php echo $business['id'] ?>&structure=<?php echo $structure['id'] ?>&curriculum=<?php echo $block['id'] ?>"><?php echo $block['authority-name'] . ' ' . $block['subject-name'] . ' ' . $block['grade-range'] . ' ' . $block['year'] ?></a>
            <div class="Block-footer">
                <span>Status: <?php echo $block['status'] ?> | Source: <?php echo $block['source'] ?> | Last updated: <?php echo $block['last-updated'] ?></span>
            </div>
        </div>
